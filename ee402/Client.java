...
public class Client {
    ...
    private void getPollutionReadings() {
    	Vector<PollutionReading> vector = new Vector<PollutionReading>();
    	vector.add(new PollutionReading("S123", (float)100.0));
    	vector.add(new PollutionReading("S234", (float)200.0));
    	vector.add(new PollutionReading("S345", (float)400.0));
    	vector.add(new PollutionReading("S456", (float)800.0));
    	PollutionReadings pr = new PollutionReadings(vector);
    	this.send(pr);
    	try{
    		String avgText = (String) receive();
