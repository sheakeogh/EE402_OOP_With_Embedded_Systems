...
public class Client {
    ...
    private void getVector() {
    	String theVectorCommand = "getVector " + stringArgs, theVector;
    	System.out.println("01. -> Sending Command (" + theVectorCommand + ") to the server...");
    	this.send(theVectorCommand);
    	try{
    		theVector = (String) receive();
    ...
    public static void main(String args[]) 
    {
    	...
    	if(args.length==4){
		    ...
		    stringArgs = args[1] + " " + args[2] + " " + args[3];
		    theApp.getVector();
		}
    	else
    	{
