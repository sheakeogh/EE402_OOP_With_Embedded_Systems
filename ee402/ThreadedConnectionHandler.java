...
public class ThreadedConnectionHandler extends Thread
{
    ...
    private boolean readCommand() {
        ...
        if(arr[0].equalsIgnoreCase("getVector")) {
        	this.getVector();
        }
        else { 
    ...
    private void getVector() {
    	String myVectorText = rng.getVector(Integer.parseInt(arr[1]), Integer.parseInt(arr[2]), Integer.parseInt(arr[3]));
    	this.send(myVectorText);
    }
